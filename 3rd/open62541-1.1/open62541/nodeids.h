 ...
 * Generated from /root/edge/open62541/tools/schema/NodeIds.csv with script /root/edge/open62541/tools/generate_nodeid_header.py
 *-------------------------------------------------------*/
 ...
 * following definitions are autogenerated from the ``/root/edge/open62541/tools/schema/NodeIds.csv`` file */
