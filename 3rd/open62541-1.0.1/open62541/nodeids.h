 ...
 * Generated from /root/open62541/tools/schema/NodeIds.csv with script /root/open62541/tools/generate_nodeid_header.py
 *-------------------------------------------------------*/
 ...
 * following definitions are autogenerated from the ``/root/open62541/tools/schema/NodeIds.csv`` file */
